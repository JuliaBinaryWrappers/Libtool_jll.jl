...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Libtool_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("a76c16ae-fb8f-5ff0-8826-da3b7a640f0b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Libtool", artifacts_toml) for e in artifacts["Libtool"]]
...
if best_platform === nothing
    @debug("Unable to load Libtool; unsupported platform $(triplet(platform_key_abi()))")
else
